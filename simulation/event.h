...
{
	EventSpawnPassenger(float time, Simulation* simulation, PassengerNode* startNode, PassengerNode* endNode, std::unordered_map<PassengerNode*, std::list<PassengerEdge*>>* path);
	void processEvent();
	Simulation* m_simulation;
	PassengerNode* m_startNode;
